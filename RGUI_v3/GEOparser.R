...
# GEOparser
# Originally from https://github.com/hongqin/RCompBio/blob/master/ncbigeo/ncbiGEO2012Nov14-demo-youtube.R
library(GEOquery)
myGSE = "GSE3821"
myGSE = "GSE1563"
...
yORFs = ORFs[grep( "Y\\w{2}\\d{3}.*", ORFs)]  #these are yeast ORFs # A method to extract certain patterns of letters
str(yORFs)
setdiff(ORFs, yORFs)
ORFs = yORFs
...
##########
#Another approach is to calculate the average signals for all the probes in the same ORFs
