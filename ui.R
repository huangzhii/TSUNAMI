...
navbarPage( theme = "style.css",
            ...
            title=div(a(img(src="images/tsunami_logo.png",
                            height = 28,
                            style = "margin:0px 0px; padding-bottom: 5px"), href="#")),
            tabPanel("Analysis",
                                           ...
                                           mainPanel(
                                             ...
                                             tabsetPanel(
                                               ...
                                               tabPanel("Circos Plots",
                                                        ...
                                                        tags$b('Please be patient as generating Circos plot may consume some time. Try not to click any button before the plot is fully generated.'),
