...
#----------------------------------------------------------------------------
  ...
  observeEvent(input$checkPower, {
    ...
    if (length(finalSym()) > 0){
      ...
      output$WGCNAPowerPlot1 <- renderPlot({
        ...
        # pdf(file = "/home/zhihuan/Desktop/plot1.pdf",   # The directory you want to save the file in
  ...
  observeEvent(input$action4_WGCNA,{
      ...
      output$WGCNAresult <- renderPlot({
          ...
          # pdf(file = "/home/zhihuan/Desktop/plot2.pdf",   # The directory you want to save the file in
          #     width = 7, # The width of the plot in inches
          #     height = 5) # The height of the plot in inches
          # plotDendroAndColors(net$dendrograms[[1]], mergedColors[net$blockGenes[[1]]],
          #                     "Module colors",
  ...
  observeEvent(input$circos_button_update_1,{
    ...
    output$circos_plot_component_hg38 <- renderPlot({
      ...
      # pdf(file = "/home/zhihuan/Desktop/plot_circos_6.pdf",   # The directory you want to save the file in
